...
class Generator(nn.Module):
    def __init__(self, noise_dim, class_dim):
        ...
        self.generator = nn.Sequential(
            ...
            nn.Conv2d(256, 256, kernel_size=3, stride=1, padding=1),  # [B, 256, 70, 80]
            nn.Conv2d(256, 256, kernel_size=3, stride=1, padding=1),  # [B, 256, 70, 80]
            ...
            nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1),  #[B, 128, 140, 160]
            nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1),  #[B, 128, 140, 160]
            ...
            nn.Conv2d(64, 64, kernel_size=3, stride=1, padding=1),  # [B, 64, 280, 320]
            nn.Conv2d(64, 64, kernel_size=3, stride=1, padding=1),  # [B, 64, 280, 320]
